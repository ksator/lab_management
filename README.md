...
- The file [**python/credentials.py**](python/credentials.py) get the devices username and password from the ansible variables file  [**/group_vars/JUNOS/credentials.yml**](/group_vars/JUNOS/credentials.yml)
