...
- [**JSNAPy inventory file**](jsnapy/testfiles/devices.yml) is created automatically (using this [**playbook**](pb.generate.jsnapy.inventory.yml)), based on the [**Ansible inventory file**](hosts) and based on the [**Ansible variables file for devices credentials**](/group_vars/JUNOS/credentials.yml)
